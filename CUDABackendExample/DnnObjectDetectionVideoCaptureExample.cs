...
{
    /// <summary>
    /// DnnObjectDetectionVideoCaptureExample
    /// </summary>
    public class DnnObjectDetectionVideoCaptureExample : MonoBehaviour
    {

        [TooltipAttribute("Path to a video file.")]
        ...
        //protected static readonly string VIDEO_FILENAME = "Girl - 27091.mp4";
...
#if UNITY_WEBGL && !UNITY_EDITOR
            getFilePath_Coroutine = Utils.getFilePathAsync(videoFile, (result) => {
...
#else
            capture.open(Utils.getFilePath(videoFile));
            Init();
#endif
